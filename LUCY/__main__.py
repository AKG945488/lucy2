...
buttons = [
    [
     ...
     [  
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ ⚒️", url="https://t.me/LUCY_BOTS"),
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇꜱ 📢", url="https://t.me/LUCY_UPDATE"),
    ], 
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Support ⚒️", callback_data="LUCY_BOTS"),
                    InlineKeyboardButton(text="Developers 🎁", callback_data="LUCY_UPDATE"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/LUCY_BOTS"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/LUCY_UPDATE"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="AKG OP", url="t.me/Base16_414b475f414e544845534d"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
                 ]
